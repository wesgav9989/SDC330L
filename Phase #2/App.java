 ...
 * Name: Wesley Gavitt
 * Date: 04/14/2026
 * Purpose: Main class for Project Week 2 Employee Management Application.
 * This file displays the title, welcomes the user, shows the menu,
 * demonstrates interface use and polymorphism, and keeps the
 * application running until the user chooses to quit.
 */
...
public class App {
    ...
    /**
     * Displays the program title, project week, student name,
     * and a short welcome message with basic instructions.
     */
    public static void displayHeader() {
        ...
        System.out.println("This program allows you to add, view, update, and remove employees.");
        System.out.println("Choose an option from the menu below to continue.");
        System.out.println();
    }
    ...
    public static void displayMenu() {
        ...
        System.out.println("6. Demonstrate Interface");
        System.out.println("7. Exit");
        System.out.println();
    }

    /**
     * Collects employee information from the user and creates
     * the correct employee object based on the chosen employee type.
     * This method demonstrates object creation using realistic data.
     *
     * @param input the Scanner used to collect user input
     * @param manager the EmployeeManager used to store new employees
     */
    ...
    /**
     * Demonstrates the direct use of the Displayable interface.
     * This makes it clear that different employee objects can be
     * treated through a shared interface reference.
     */
    public static void demonstrateInterface() {
        System.out.println("\nInterface Demonstration");
        System.out.println("----------------------------------------");

        Displayable displayableEmployee = new SalariedEmployee(
                2000,
                "Demo",
                "Employee",
                new Address("1 Test St", "Hopewell", "VA", "23860"),
                60000.00);

        displayableEmployee.displayInfo();
    }

    /**
     * Pauses the program until the user presses Enter.
     *
     * @param input the Scanner used to wait for user input
     */
